 ...
 *
 */
public enum STAFFAutorisations implements Autorisations {
	...
	STAFFAutorisations(Fonctions fonction, boolean limiteASesInfos) {
		this.fonction = fonction;
		this.limiteASesInfos = limiteASesInfos;
	}
	
	STAFFAutorisations(Fonctions fonction) {
		this.fonction = fonction;
