 ...
 *
 */
public enum CommercialAutorisations  implements Autorisations {
	...
	CommercialAutorisations(Fonctions fonction, boolean limiteASesInfos) {
		this.fonction = fonction;
		this.limiteASesInfos = limiteASesInfos;
	}
	
	CommercialAutorisations(Fonctions fonction) {
		this.fonction = fonction;
